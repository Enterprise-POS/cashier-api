...
type StoreStock struct {
	...
	Item *Item `json:"item,omitempty" gorm:"foreignKey:ItemId;references:ItemId"`
}
...
*/
/*
By gorm convention if we use update_at at table column definition
gorm will update automatically every time update, save method is called
*/
