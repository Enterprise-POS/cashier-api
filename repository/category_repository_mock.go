...
func (repository *CategoryRepositoryMock) GetCategoryWithItems(tenantId int, page int, limit int, nameQuery string, categoryId int) ([]*model.CategoryWithItem, int, error) {
	args := repository.Mock.Called(tenantId, page, limit, nameQuery, categoryId)
